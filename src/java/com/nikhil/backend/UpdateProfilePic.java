...
public class UpdateProfilePic extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String file_name = "profile-pic.png";
        try {
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("update profile_details set profile_url=? where email=?");
            ...
            if (rowCount > 0) {
                ...
                sesssion.setAttribute("profile_url", file_name);
