...
public class UpdateProject extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            PreparedStatement ps1 = con.prepareStatement("update users_projects set title=?, about=?, start_date=?, end_date=? where id=?");
            ps1.setString(1, project_title);
            ps1.setString(2, project_about);
            ps1.setString(3, project_start_date);
            ps1.setString(4, project_end_date);
            ps1.setString(5, id);
