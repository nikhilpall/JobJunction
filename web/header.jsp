                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="login-register navbar-nav mb-2 mb-lg-0">
                            <li>
                                <span><a href="login.jsp" style="text-decoration: none; color: white;">Login</a></span>
                                <span style="color:white;">/</span>
                                <span><a href="register.jsp" style="text-decoration: none; color: white;">Register</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
