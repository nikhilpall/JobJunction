                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="edit-profile-form">
                            <form method="POST" name="edit_form" onsubmit="return validation()" action="update_profile" enctype="multipart/form-data">
                                <table>
                                    <tr>
                                        ...
                                        <td style="padding: 15px 30px;"><h1>Edit Profile </h1><b><jsp:expression>full_name</jsp:expression></b> (<jsp:expression>email</jsp:expression>)</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"><br><br></td>
                                    </tr>
                                    <tr class="edit-table-row">
                                        <td><b>Add profile picture</b></td>
                                        <td><input type="file" name="user_profile_pic" accept=".png, .jpg" required=""/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: center;"><span style="color: red;">(NOTE : Please upload 1:1 ratio image)</span></td>
                                    </tr>
                                    <tr>
